...
@Component({
  selector: 'app-popular-things-six',
  standalone: false,
  templateUrl: './popular-things-six.component.html',
  styleUrl: './popular-things-six.component.css'
})
export class PopularThingsSixComponent {
  activity = {
    title: 'S.E.A Aquarium Tickets',
    image: '/assets/images/SEA Aquarium Tickets-8.webp',
    rating: 4.8,
    reviews: 1250,
    booked: 5000,
  ...
  highlights = `The S.E.A. Aquarium, located on Sentosa Island in Singapore, is one of the world's largest and most impressive marine life attractions. Part of Resorts World Sentosa, it houses over 100,000 marine animals from more than 1,000 species, spread across over 40 diverse habitats. Visitors can explore a variety of zones, including the Open Ocean Habitat, which features a massive viewing panel, and the Shark Seas, home to 12 species of sharks Headout
  Interactive programs, up-close animal encounters, and immersive learning journeys are designed to inspire visitors    to  protect the world's oceans.The aquarium also offers unique experiences like the Sea Jellies Gallery and the Coral Garden, showcasing the vibrant diversity of marine life`;
  ...
  skylineluge = [
    ...
    {
      image: '/assets/images/SEA Aquarium Tickets-5.jpg'
    },
    {
      image: '/assets/images/SEA Aquarium Tickets-2.jpg',
    },
    {
      image: '/assets/images/SEA Aquarium Tickets-3.jpg',
    },
    {
      image: '/assets/images/SEA Aquarium Tickets-6.jpg',
    }
  ];
