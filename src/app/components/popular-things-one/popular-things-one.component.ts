...
export class PopularThingsOneComponent {
  activity = {
    ...
    reviews: 1250,
    booked: 5000,
    location: '8 Sentosa GatewayResorts, World Sentosa, Sentosa Island, Singapore',
    price: 6933
  };
  wishlistService: any;
  savedCount: any;
  ...
  highlights = `Universal Studios Singapore is a world-class theme park offering an exhilarating mix of rides, shows, and attractions spread across seven themed zones. One of the top highlights is Battlestar Galactica: HUMAN vs. CYLON, the world’s tallest dueling roller coasters, which thrill-seekers absolutely love. For movie buffs, Transformers: The Ride 3D delivers an adrenaline-pumping battle in high-definition, while families and kids adore the Far Far Away castle and Madagascar boat ride. You can also meet your favorite characters like the Minions, Shrek, and the Jurassic Park raptors during meet-and-greet sessions. With captivating street performances, immersive set designs, and a variety of dining and shopping experiences, Universal Studios Singapore is a must-visit attraction that promises fun and excitement for all ages.`;
