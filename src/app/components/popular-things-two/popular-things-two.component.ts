...
@Component({
  selector: 'app-popular-things-two',
  standalone: false,
  templateUrl: './popular-things-two.component.html',
  styleUrl: './popular-things-two.component.css'
})
export class PopularThingsTwoComponent {
  activity = {
  ...
  highlights = `Gardens by the Bay is a breathtaking nature park in the heart of Singapore that beautifully blends futuristic architecture with vibrant horticulture. One of its most iconic highlights is the Supertree Grove, featuring towering vertical gardens that come alive at night with a dazzling light and sound show. Visitors are also drawn to the Flower Dome, the world’s largest glass greenhouse, showcasing exotic plants from Mediterranean regions, and the Cloud Forest, which houses a lush mountain landscape, complete with a dramatic indoor waterfall and mist-filled walkways. The entire park offers a serene yet visually stunning escape, making it a perfect destination for nature lovers, photographers, and families looking to experience Singapore's commitment to sustainability and innovation.`;
  ...
  skylineluge = [
    ...
    {
      image: '/assets/images/Gardens by the bay-1.jpg'
    },
    {
      image: '/assets/images/Gardens-by-the-Bay-2.jpg',
    },
    {
      image: '/assets/images/Gardens-by-the-Bay-3.jpg',
    },
    {
