...
export class PopularThingsNineComponent {
  ...
  highlights = `Bird Paradise in Singapore is a renowned aviary located within the Mandai Wildlife Reserve. Opened on May 8, 2023, it replaced the former Jurong Bird Park and offers visitors an immersive experience with a diverse range of bird species in carefully designed habitats.`;
