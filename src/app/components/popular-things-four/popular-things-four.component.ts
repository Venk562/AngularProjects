...
@Component({
  selector: 'app-popular-things-four',
  standalone: false,
  templateUrl: './popular-things-four.component.html',
  styleUrl: './popular-things-four.component.css'
})
export class PopularThingsFourComponent {
  activity = {
  ...
  highlights = `Night Safari Singapore is the world's first nocturnal wildlife park, offering a unique experience to observe over 900 animals from more than 100 species in their natural nighttime habitats. Visitors can embark on a guided tram ride that traverses seven geographical zones, providing close encounters with creatures like Asian elephants, Malayan tigers, and spotted hyenas. For those who prefer exploring on foot, four walking trails—Pangolin, Leopard, East Lodge, and Tasmanian Devil—offer immersive experiences. A highlight of the visit is the "Creatures of the Night" show, where animals showcase their natural behaviors, emphasizing the importance of conservation and sustainability.`;
  ...
  skylineluge = [
    ...
    {
      image: '/assets/images/night safari tickets-3.webp'
    },
    {
      image: '/assets/images/night safari tickets-4.avif',
    },
    {
      image: '/assets/images/night safari tickets-5.jpg',
    },
    {
      image: '/assets/images/night safari tickets-6.jpg',
    }
  ];
